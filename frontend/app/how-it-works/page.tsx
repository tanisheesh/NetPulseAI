    ...
    <div className="min-h-screen bg-[#0a0a0f] text-[#f1f5f9]">
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-[#6366f1] via-[#8b5cf6] to-[#06b6d4] bg-clip-text text-transparent">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#12121a] border border-[#1e1e2e] rounded-xl p-8">
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="bg-[#0a0a0f] border border-blue-500/30 rounded-lg p-4">
              ...
              <div className="bg-[#0a0a0f] border border-purple-500/30 rounded-lg p-4">
                <div className="text-purple-400 font-bold mb-2">AI Weighted</div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#12121a] border border-[#1e1e2e] rounded-xl p-6">
              <h3 className="text-2xl font-bold text-[#6366f1] mb-4">Backend (Python/FastAPI)</h3>
            ...
            {/* Frontend */}
            <div className="bg-[#12121a] border border-[#1e1e2e] rounded-xl p-6">
              <h3 className="text-2xl font-bold text-[#8b5cf6] mb-4">Frontend (Next.js/React)</h3>
              <ul className="space-y-3 text-[#64748b]">
                <li className="flex items-start gap-3">
      ...
      {/* Simulation Flow */}
      <section className="py-12 px-6 bg-[#12121a]/30">
        <div className="max-w-4xl mx-auto">
            ...
            {[
              {
                ...
                color: "from-[#6366f1] to-[#6366f1]/50"
              },
              {
                step: "2",
              ...
              <div key={item.step} className="bg-[#12121a] border border-[#1e1e2e] rounded-xl p-6 relative overflow-hidden">
                <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${item.color}`}></div>
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#6366f1] to-[#8b5cf6] rounded-lg flex items-center justify-center font-bold">
                    {item.step}
                  </div>
                  <div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={user.name} className={`bg-[#12121a] border ${user.color} rounded-xl p-6`}>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={metric.name} className="bg-[#12121a] border border-[#1e1e2e] rounded-xl p-6">
                <div className="flex items-start justify-between mb-3">
                  <h3 className="text-xl font-bold">{metric.name}</h3>
                  <span className="px-3 py-1 bg-[#6366f1]/20 text-[#6366f1] text-sm rounded-full font-medium">
          ...
          <div className="bg-[#12121a] border border-[#1e1e2e] rounded-xl p-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-[#0a0a0f] border border-[#1e1e2e] rounded-lg p-4">
                <div className="text-2xl font-bold text-[#6366f1] mb-2">10 ticks</div>
                <div className="text-sm text-[#64748b]">= 1 second</div>
              </div>
              <div className="bg-[#0a0a0f] border border-[#1e1e2e] rounded-lg p-4">
                <div className="text-2xl font-bold text-[#8b5cf6] mb-2">100 ticks</div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] rounded-2xl p-12 text-center">
          ...
          <Link
            href="/dashboard"
            className="inline-block px-8 py-4 bg-white text-[#6366f1] rounded-xl font-semibold text-lg hover:bg-gray-100 transition-colors"
          >
            Launch Simulator
          </Link>
        </div>
